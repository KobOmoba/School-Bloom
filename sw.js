...
const CACHE_NAME   = 'edubloom-School-Bloom-20260826-basic-fix';
const SHELL_ASSETS = [
...
self.addEventListener('install', event => {
  console.log('[SW] Installing Edu-BLOOM v1.5.0...');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[SW] Activating Edu-BLOOM v1.5.0...');
  event.waitUntil(
...
console.log('[SW] Edu-BLOOM Service Worker v1.5.0 loaded ✅');
